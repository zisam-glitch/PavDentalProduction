...
const team = [
...

  {
    ...
    specializationstitle: "What Waleed helps with",
    specializations: [
      "New patient onboarding & medical history checks",
      "Estimates, finance options, and membership plan setup",
      "Coordinating multi-visit treatment plans & reminders",
      "Post-op check-ins, feedback, and complaint resolution",
      "Supporting the clinical team and overseeing day-to-day practice operations",
    ],
    date: "Monday–Friday (with weekend cover for urgent cases)",
    language: "English, Urdu",
    contact: "Call 0800 1938 786 — “Ask for Waleed”",
